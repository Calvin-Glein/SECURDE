...
/**
 * Servlet implementation class GetMagazinesServlet
 */
@WebServlet("/GetMagazinesServlet")
public class GetMagazinesServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GetMagazinesServlet() {
		super();
